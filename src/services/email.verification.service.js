  ...
  forgotPassword: async (email) => {
    ...
    try {
      ...
      await mailer.send(email, {
        ...
        text: `It looks like someone requested to reset the password associated with this email. Please click on the link below to reset your password: 
        https://myriade.io/#/forgotpassword?token=${tok}
        
        If you did not request a password reset on Myriade, feel free to ignore this e-mail.
        Thank you!`,
        html: `
        <div>
          <h5>It looks like someone requested to reset the password associated with this email. Please click on the link below to reset your password</h5>
          <p>If you did not request a password reset on Myriade, feel free to ignore this e-mail.</p>
          <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="border-radius: 2px;" bgcolor="#DE5100">
                                <a href="https://myriade.io/#/forgotpassword?token=${tok}" target="_blank" style="padding: 8px 12px; border: 1px solid #DE5100;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;">
                                    Reset your password    
                                </a>
                            </td>
                        </tr>
